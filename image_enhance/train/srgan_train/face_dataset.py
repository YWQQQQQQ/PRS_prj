...
class FACE:
    def __init__(self,
                 scale=4,
                 subset='train',
                 images_dir='face/images',
                 caches_dir='face/caches'):
        ...
        if subset == 'train':
            self.image_ids = range(1, 201)
        elif subset == 'valid':
            self.image_ids = range(201, 221)
        else:
    ...
    def _lr_images_dir(self):
        return os.path.join(self.images_dir, f'{self.subset}_LR')
